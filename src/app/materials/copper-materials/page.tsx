    ...
    <div className="min-h-screen bg-[#F4F3EE] pt-20">
      <div className="flex">
        ...
        <main className="flex-1">
          ...
          {/* Materials List */}
          <section className="px-8 lg:px-16 py-12">
            <h2 className="text-3xl font-bold text-[#1D2931] mb-8">WIRBALIT® Copper Alloy Range</h2>
            <div className="space-y-4">
              {materials.map((material) => (
                <Link
                  key={material.composition}
                  href={material.href}
                  className="flex items-center justify-between p-6 border border-gray-200 rounded-lg hover:shadow-lg transition-all group"
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2">
                      ...
                      <span className="text-[#EF290E] font-mono">{material.composition}</span>
          ...
          <section className="px-8 lg:px-16 py-12 border-t border-gray-200">
            <div className="flex flex-col md:flex-row items-center justify-between p-8 border border-gray-200 rounded-lg">
              <div className="mb-6 md:mb-0">
                <h2 className="text-2xl font-bold text-[#1D2931] mb-2">Compare All Materials</h2>
                <p className="text-[#6F7B83]">
